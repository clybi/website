...
const SUBJECTS = [
  ...
  { id: 'english-for-academic',  strand: 'core', color: '#2d5a45', tag: 'Core', tagColor: '#e8f4ec', tagText: '#2d5a45',
    ...
    desc: 'Develop academic writing skills — research, reports, proposals — and professional communication.',
    progress: 0, total: 5 },
  { id: 'practical-research-2',  strand: 'core', color: '#2d5a45', tag: 'Core', tagColor: '#e8f4ec', tagText: '#2d5a45',
    ...
    desc: 'Quantitative research methods, data collection, statistical analysis, and research paper writing.',
    progress: 0, total: 5 },
  { id: 'filisopiya',            strand: 'core', color: '#2d5a45', tag: 'Core', tagColor: '#e8f4ec', tagText: '#2d5a45',
    ...
    desc: "Kritikal na pagbabasa at pagsusuri ng iba't ibang uri ng teksto tungo sa matalinong komunikasyon.",
    progress: 0, total: 5 },
  { id: 'understanding-culture', strand: 'core', color: '#2d5a45', tag: 'Core', tagColor: '#e8f4ec', tagText: '#2d5a45',
    ...
    desc: 'Sociological and political concepts applied to Philippine society — culture, identity, governance.',
    progress: 0, total: 5 },
  { id: 'media-info',            strand: 'core', color: '#2d5a45', tag: 'Core', tagColor: '#e8f4ec', tagText: '#2d5a45',
    ...
    desc: 'Evaluate, create, and use media and information responsibly in the digital age.',
    progress: 0, total: 5 },
  { id: 'pe-health-4',           strand: 'core', color: '#2d5a45', tag: 'Core', tagColor: '#e8f4ec', tagText: '#2d5a45',
    title: 'PE and Health 4', sub: 'Grade 12 – Core',
    desc: 'Active recreation, community health, first aid, and lifelong fitness programs.',
    progress: 0, total: 4 },
  // ── STEM (Grade 12) ──────────────────────────────────────────────────────
  { id: 'gen-bio-2',             strand: 'stem', color: '#1a4a7a', tag: 'STEM', tagColor: '#e2eaf8', tagText: '#1a4a7a',
    title: 'General Biology 2', sub: 'Grade 12 – STEM',
    desc: 'Plant and animal anatomy, ecology, evolution, biodiversity, and conservation biology.',
    progress: 0, total: 5 },
  { id: 'gen-chem-2',            strand: 'stem', color: '#1a4a7a', tag: 'STEM', tagColor: '#e2eaf8', tagText: '#1a4a7a',
    ...
    desc: 'Chemical equilibrium, acids & bases, electrochemistry, and organic chemistry fundamentals.',
    progress: 0, total: 5 },
  { id: 'basic-calculus',        strand: 'stem', color: '#1a4a7a', tag: 'STEM', tagColor: '#e2eaf8', tagText: '#1a4a7a',
    title: 'Basic Calculus', sub: 'Grade 12 – STEM',
    desc: 'Limits, derivatives, antiderivatives, and integrals and their real-world applications.',
    progress: 0, total: 5 },
  { id: 'gen-physics-1',         strand: 'stem', color: '#1a4a7a', tag: 'STEM', tagColor: '#e2eaf8', tagText: '#1a4a7a',
    ...
    desc: 'Kinematics, Newton\'s laws, work-energy theorem, rotational motion, and fluid mechanics.',
    progress: 0, total: 5 },
  { id: 'research-sci',          strand: 'stem', color: '#1a4a7a', tag: 'STEM', tagColor: '#e2eaf8', tagText: '#1a4a7a',
    ...
    desc: 'Scientific method, experimental design, data analysis, and science communication.',
    progress: 0, total: 4 },
  // ── HUMSS (Grade 12) ─────────────────────────────────────────────────────
  { id: 'creative-writing',      strand: 'humss', color: '#7a3a1a', tag: 'HUMSS', tagColor: '#f8ede2', tagText: '#7a3a1a',
    ...
    desc: 'Craft poetry, short fiction, scripts, and creative nonfiction using literary techniques.',
    progress: 0, total: 5 },
  { id: 'community-engagement',  strand: 'humss', color: '#7a3a1a', tag: 'HUMSS', tagColor: '#f8ede2', tagText: '#7a3a1a',
    ...
    desc: 'Concepts of community, social responsibility, volunteerism, and civic participation.',
    progress: 0, total: 4 },
  { id: 'trends-networks',       strand: 'humss', color: '#7a3a1a', tag: 'HUMSS', tagColor: '#f8ede2', tagText: '#7a3a1a',
    ...
    desc: 'Globalization, social networks, critical and creative thinking in the 21st century.',
    progress: 0, total: 5 },
  { id: 'philliterature',        strand: 'humss', color: '#7a3a1a', tag: 'HUMSS', tagColor: '#f8ede2', tagText: '#7a3a1a',
    ...
    desc: 'Philippine political system, Constitution, branches of government, and democratic processes.',
    progress: 0, total: 5 },
  // ── ABM (Grade 12) ───────────────────────────────────────────────────────
  { id: 'fundamentals-accountancy', strand: 'abm', color: '#4a1a7a', tag: 'ABM', tagColor: '#ede2f8', tagText: '#4a1a7a',
    ...
    desc: 'Financial statements, statement of comprehensive income, and basic accounting cycle.',
    progress: 0, total: 5 },
  { id: 'applied-economics',     strand: 'abm', color: '#4a1a7a', tag: 'ABM', tagColor: '#ede2f8', tagText: '#4a1a7a',
    ...
    desc: 'Microeconomics, macroeconomics, supply & demand, market structures, and Philippine economy.',
    progress: 0, total: 5 },
  { id: 'business-finance',      strand: 'abm', color: '#4a1a7a', tag: 'ABM', tagColor: '#ede2f8', tagText: '#4a1a7a',
    ...
    desc: 'Time value of money, financial markets, capital budgeting, and corporate finance basics.',
    progress: 0, total: 5 },
  { id: 'marketing',             strand: 'abm', color: '#4a1a7a', tag: 'ABM', tagColor: '#ede2f8', tagText: '#4a1a7a',
    ...
    desc: 'Marketing mix, consumer behavior, branding, digital marketing, and market research.',
    progress: 0, total: 5 },
  // ── TVL (Grade 12) ───────────────────────────────────────────────────────
  { id: 'empowerment-tech',      strand: 'tvl', color: '#7a5a1a', tag: 'TVL', tagColor: '#f8f0e2', tagText: '#7a5a1a',
    ...
    desc: 'ICT for professional tracks — productivity tools, online platforms, and digital citizenship.',
    progress: 0, total: 5 },
  { id: 'entrep',                strand: 'tvl', color: '#7a5a1a', tag: 'TVL', tagColor: '#f8f0e2', tagText: '#7a5a1a',
    ...
    desc: 'Business planning, feasibility study, marketing strategy, and launching a small enterprise.',
    progress: 0, total: 5 },
];

/* ===== LESSONS — Grade 12 SHS, YouTube discussions ===== */
...
function initDashboard() {
  ...
  // Continue learning — show first 3 subjects
  const featured = SUBJECTS.slice(0, 3);
  const container = document.getElementById('continueCards');
  container.innerHTML = featured.map(s => subjectCardHTML(s)).join('');

  // Activity list
  const activities = [
    { icon: '🎬', title: 'Watched: What is Academic Writing?', detail: 'English for Academic & Professional Purposes', time: '2 hours ago' },
    { icon: '📝', title: 'Took Quiz: Supply and Demand', detail: 'Applied Economics – Score: 9/10', time: 'Yesterday' },
    { icon: '✅', title: 'Completed: Limits Introduction', detail: 'Basic Calculus', time: 'Yesterday' },
    { icon: '🔖', title: 'Saved: Newton\'s Laws of Motion', detail: 'General Physics 1', time: '2 days ago' },
    { icon: '🎬', title: 'Watched: Fake News and Fact-Checking', detail: 'Media and Information Literacy', time: '3 days ago' },
  ];
...
function initSubjects() {
  ...
  if (strand) {
    ...
    document.querySelectorAll('.filter-tab').forEach(t => {
      t.classList.toggle('active', t.textContent.toLowerCase() === strand ||
        (strand === 'core' && t.textContent === 'Core'));
    });
  }
  renderSubjects();
}
...
function renderSubjects() {
  ...
  document.getElementById('subjectsGrid').innerHTML = filtered.map(s => subjectCardHTML(s)).join('');
}

/* ===== VIDEO CARD LOADER (no embed = no errors) ===== */
...
function loadVideo(videoId, lessonTitle) {
  ...
  const searchUrl  = 'https://www.youtube.com/results?search_query=' +
    encodeURIComponent('Grade 12 SHS Philippines ' + lessonTitle + ' lesson discussion');

  // YouTube thumbnail (maxresdefault, fallback to hqdefault)
  ...
  if (thumb) {
    ...
    thumb.onerror = function() {
      ...
      this.onerror = function() {
        // If both fail (deleted/private video), show a search thumbnail
        this.onerror = null;
        document.getElementById('videoCard').style.backgroundImage =
          'linear-gradient(135deg, #1c1c2e 0%, #2d5a45 100%)';
        this.style.display = 'none';
        // Re-point click to YouTube search
  ...
  // Update the YouTube button in lesson actions
...
function initLesson() {
  ...
  const lessons = LESSONS[subject.id] || getDefaultLessons(subject.id);
  ...
  // Video — card loader (opens YouTube directly)
...
/* ===== SIGN-IN REDIRECT (handled by auth.js) ===== */

/* ===== INIT ===== */
document.addEventListener('DOMContentLoaded', () => {
  // Route guard — redirect to login if not authenticated
  if (typeof AUTH !== 'undefined') {
    const isAuthPage = ['index.html', 'login.html'].some(p => window.location.pathname.endsWith(p))
      || window.location.pathname === '/' || window.location.pathname.endsWith('/');
    if (!isAuthPage) {
      if (!AUTH.requireAuth()) return; // stops execution if redirected
    }
  }

  // Personalize: show real user's name and initials
